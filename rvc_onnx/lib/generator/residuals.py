...
from lib.generator.commons import get_padding, init_weights


LRELU_SLOPE = 0.1

def create_conv1d_layer(channels, kernel_size, dilation):
    """Helper function to create a weight-normalized Conv1d layer."""
...
class ResBlock(ResBlockBase):
    """Residual Block with default kernel size and dilation."""
    def __init__(self, channels, kernel_size=3, dilation=(1, 3, 5)):
        super(ResBlock, self).__init__(channels, kernel_size, dilation)

class Log(torch.nn.Module):
    """Logarithm operation for flow-based models."""
